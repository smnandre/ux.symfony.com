...
{
    public function testAColorCanBeSelected(): void
    {
    ...
    public function testAFilterCanBeClearedAndAlwaysResetsThePage(): void
    {
        $component = new LivePagination(
            $this->createStub(PaginatorInterface::class),
            new JerseyRepository(),
    ...
    public function testPaginationLinksContainTheActiveLiveFilters(): void
    {
        ...
        self::assertSame('/pagination?color=pink&pattern=halves&page=2', $component->getPagination()->getUrl(2));
    }
}
