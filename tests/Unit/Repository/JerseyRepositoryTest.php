...
{
    public function testItGeneratesEveryCombinationWithAStableId(): void
    {
    ...
    public function testItDistributesEveryDimensionEvenly(): void
    {
        $jerseys = new JerseyRepository()->find();
    ...
    public function testItTemporarilyOrdersByColorSecondaryAndPattern(): void
    {
        $jerseys = new JerseyRepository()->find();
    ...
    public function testTheSecondaryChoosesTheLogoTreatment(): void
    {
    ...
    public function testItFiltersByDisplayedColorAndPattern(): void
    {
        $repository = new JerseyRepository();
